...
g.k.rE=function(){this.tooltip=new g.vQ(this.player,this);g.I(this,this.tooltip);g.IM(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.uc=new g.ON(this.player);g.I(this,this.uc);this.Dg=new g.V({G:"div",L:"ytp-miniplayer-scrim"});g.I(this,this.Dg);this.Dg.Da(this.element);this.T(this.Dg.element,"click",this.iA);var a=new g.V({G:"button",Ga:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"Cerrar"},U:[g.PK()]});g.I(this,a);a.Da(this.Dg.element);this.T(a.element,"click",this.Ei);
...
Ga:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"Cerrar"},U:[g.PK()]});g.I(this,a);a.Da(this.Wz.element);this.T(a.element,"click",this.Ei);a=new g.V({G:"button",Ga:["ytp-miniplayer-replay-button","ytp-button"],W:{"aria-label":"Cerrar"},U:[g.UK()]});g.I(this,a);a.Da(this.Wz.element);this.T(a.element,"click",this.uV);this.T(this.player,"presentingplayerstatechange",this.Mc);this.T(this.player,"appresize",this.wb);this.T(this.player,"fullscreentoggled",this.wb);this.wb()};
